...
! function(a) {
    ...
    n.DEFAULTS = {
        ...
        n.prototype.initContainer = function() {
            this.$container = a(['<div class="bootstrap-table">', '<div class="fixed-table-toolbar"></div>', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination mt-10" style="clear: both;"></div>' : "", '<div class="fixed-table-container">', '<div class="fixed-table-header"><table></table></div>', '<div class="fixed-table-body">', '<div class="fixed-table-loading">', this.options.formatLoadingMessage(), "</div>", "</div>", '<div class="fixed-table-footer"><table><tr></tr></table></div>', "bottom" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination mt-10"></div>' : "", "</div>", "</div>"].join("")),
                    ...
                    e.push("<tr>"),
                        ...
                        a.each(g, function(a, f) {
                            ...
                            e.push("<th" + c(' title="%s"', f.titleTooltip), f.checkbox || f.radio ? c(' class="bs-checkbox %s"', f["class"] || "") : k, c(' style="%s"', h + j), c(' rowspan="%s"', f.rowspan), c(' colspan="%s"', f.colspan), c(' data-field="%s"', f.field), "tabindex='0'", ">"),
                                ...
                                g = f.title,
                                f.checkbox && (!b.options.singleSelect && b.options.checkboxHeader && (g = '<div class=\"checkbox-custom checkbox-default mt-0 mb-0\"> <input id="btSelectAll" name="btSelectAll" type="checkbox" /><label class=\"ml-10\" for=\"btSelectAll\"></label></div>'), b.header.stateField = f.field),
        ...
        n.prototype.initBody = function(b) {
            ...
            for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
                ...
                n._data && !a.isEmptyObject(n._data) && a.each(n._data, function(a, b) {
                    ...
                    this.options.cardView && g.push(c('<td colspan="%s">', this.header.fields.length)), !this.options.cardView && this.options.detailView && g.push("<td>", '<a class="detail-icon" href="javascript:">', c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen), "</a>", "</td>"),
                    a.each(this.header.fields, function(b, i) {
                        ...
                        if (x.visible) {
                            ...
                            n["_" + i + "_data"] && !a.isEmptyObject(n["_" + i + "_data"]) && a.each(n["_" + i + "_data"], function(a, b) {
                                ...
                                x.checkbox || x.radio ? (q = x.checkbox ? "checkbox" : q, q = x.radio ? "radio" : q, j = [f.options.cardView ? '<div class="card-view">' : '<td class="bs-checkbox">', "<div class='checkbox-custom checkbox-default mt-0 mb-0'> <input" + c(' id="chk%s"', k) + c(' data-index="%s"', k) + c(' name="%s"', f.options.selectItemName) + c(' type="%s"', q) + c(' value="%s"', n[f.options.idField]) + c(' checked="%s"', l === !0 || l && l.checked ? "checked" : void 0) + c(' disabled="%s"', !x.checkboxEnabled || l && l.disabled ? "disabled" : void 0) + " /><label class=\"ml-10\" for=" + c('"chk%s"', k) + "></label></div>", f.header.formatters[b] && "string" == typeof l ? l : "", f.options.cardView ? "</div>" : "</td>"].join(""), n[f.header.stateField] = l === !0 || l && l.checked) : (l = "undefined" == typeof l || null === l ? f.options.undefinedText : l, j = f.options.cardView ? ['<div class="card-view">', f.options.showHeader ? c('<span class="title" %s>%s</span>', o, d(f.columns, "field", "title", i)) : "", c('<span class="value">%s</span>', l), "</div>"].join("") : [c("<td%s %s %s %s %s %s>", s, t, o, u, v, w), l, "</td>"].join(""), f.options.cardView && f.options.smartDisplay && "" === l && (j = "")),
                                g.push(j)
                        }
                    }),
        ...
        n.prototype.resetView = function(a) {
            var b = 0;
            var sp = this.$selectAll;
            if (null == sp) {
                return;
            }
            if (a && a.height && (this.options.height = a.height), sp.prop("checked", this.$selectItem.length > 0 && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.options.height) {
