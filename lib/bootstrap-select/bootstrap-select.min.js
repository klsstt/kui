		...
		e.VERSION = "1.10.0", e.DEFAULTS = {
			...
			createDropdown: function() {
				var b = this.multiple || this.options.showTick ? " show-tick" : "",
					...
					g = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="kui-form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + c(this.options.liveSearchPlaceholder) + '"') + "></div>" : "",
			...
			liHeight: function(b) {
				if (b || this.options.size !== !1 && !this.sizeInfo) {
					...
					if (i.className = "text", c.className = this.$menu[0].parentNode.className + " open", d.className = "dropdown-menu open", e.className = "dropdown-menu inner", f.className = "divider", i.appendChild(document.createTextNode("Inner text")), h.appendChild(i), g.appendChild(h), e.appendChild(g), e.appendChild(f), j && d.appendChild(j), k) {
						...
						k.className = "bs-searchbox", n.className = "kui-form-control", k.appendChild(n), d.appendChild(k)
					}
			...
			selectPosition: function() {
				...
				var b, c, d = this,
					e = function(a) {
						d.$bsContainer.addClass(a.attr("class").replace(/kui-form-control|fit-width/gi, "")).toggleClass("dropup", a.hasClass("dropup")), b = a.offset(), c = a.hasClass("dropup") ? 0 : a[0].offsetHeight, d.$bsContainer.css({
							top: b.top + c,
							left: b.left,
					...
					if (b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass("disabled")) {
						...
						if (b.multiple) {
							if (j.prop("selected", !k), b.setSelected(e, !k), d.blur(), m !== !1 || n !== !1) {
								...
								if (m && o || n && p) if (m && 1 == m) i.prop("selected", !1), j.prop("selected", !0), b.$menuInner.find(".selected").removeClass("selected"), b.setSelected(e, !0);
								else if (n && 1 == n) {
