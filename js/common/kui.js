...
(function(win, doc, $) {
    ...
    $["kui"]["contentIframeTabs"] = {
        ...
        'bind': function() {
            ...
            sc['on']("click.site.contabs", "button.pull-left",
                function() {
            ...
            $(doc)['on']("click", '#admui-signOut', function() {
        ...
        'ifameTabs': function(e) {
            ...
            $(obj)['on']("click", "a[data-iframe]", function(temp) {
                var a = $(this),
                    ...
                    id = a['data']("iframe") || '#admui-pageContent',
                    target = a['is']("[target=\"_blank\"]");
                reg = new RegExp(/^([a-zA-z]+:|#|javascript|www\.)/);
                if (reg["test"](url)) {
                    return;
                }
                if (target && id === '#admui-pageContent') {
        ...
        '_defaultTab': function() {
            var a = $('#admui-siteConTabs')['find']("li:first > a"),
                data;
        ...
        'resize': function() {
            var ctabs = $["kui"]["contentIframeTabs"],
                sc = $(".site-contabs"),
                ct = sc["find"]("ul.con-tabs");
