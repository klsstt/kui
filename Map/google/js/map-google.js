...
mapobject.maps.initMap = function(id, jindu, weidu, zoom){
	...
	var myOptions = {zoom:this.MAX_ZOOM,scaleControl:true,center:myLatlng,mapTypeId:mapobject.maps.MapTypeId.ROADMAP,mapTypeControlOptions:{mapTypeIds:[mapobject.maps.MapTypeId.ROADMAP,mapobject.maps.MapTypeId.SATELLITE,"OSM"]}};

	var map = new mapobject.maps.Map(document.getElementById(this.container), myOptions);

    //Define OSM map type pointing at the OpenStreetMap tile server
	map.mapTypes.set("OSM", new mapobject.maps.ImageMapType({
	    getTileUrl: function (coord, zoom)
	    {
	        return "http://tile.openstreetmap.org/" + zoom + "/" + coord.x + "/" + coord.y + ".png";
	    },
	    tileSize: new mapobject.maps.Size(256, 256),
	    name: "OpenStreetMap",
	    maxZoom: 18
	}));
